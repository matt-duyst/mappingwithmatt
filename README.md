...
## Maps archive
maps/ holds 31 UCLA coursework projects from 2014 to 2018, converted from the original Jekyll site (archived on the archive-2020 branch of mapping-with-matt) to plain pages with WebP images. Basemap credits are shown where a project used an Esri basemap; a 1950 Sanborn sheet is described but not reproduced.
